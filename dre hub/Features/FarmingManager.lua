-- ==================================================
-- DRE HUB | FEATURE | Farming Manager (NEW)
...
local function StopAll()
    if _G.DRE_AFKSystem and _G.DRE_AFKSystem.IsEnabled() then
        local TreadmillPos = _G.DRE_AFKSystem.GetMyTreadmillPos()
    ...
    if _G.DRE_VIPTP and _G.DRE_VIPTP.IsEnabled() then
        _G.DRE_VIPTP.Disable()
        print("[FarmingManager] ✅ VIPTP Stopped")
    end

    if _G.DRE_TeleportSystem and _G.DRE_TeleportSystem.IsEnabled() then
        _G.DRE_TeleportSystem.Disable()
...
local function StartVIPTP(EggUid)
    ...
    _G.DRE_VIPTP.SetTargetId(EggUid)
    _G.DRE_VIPTP.Enable()
end
