...
local function EnableAutoHit()
    ...
    print("[DRE] Auto Fire Remote (Range 17 + Fast): ON")
end
...
local function DisableAutoHit()
    ...
    print("[DRE] Auto Fire Remote: OFF")
end
