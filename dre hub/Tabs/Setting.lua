...
local TabsManager = _G.DRE_TabsManager
...
local SelectedMethod = _G.DRE_SelectedMethod or "TeleportFly"
...
local function CreateOption(Name, Order)
    ...
    Option.MouseButton1Click:Connect(function()
        ...
        _G.DRE_SelectedMethod = Name

        if _G.DRE_ConfigSystem then
            _G.DRE_ConfigSystem.Save()
        end

        print("[DRE] Method Teleport Selected: " .. Name)
    end)
...
if _G.DRE_SelectedMethod == nil then
    _G.DRE_SelectedMethod = "TeleportFly"
end
...
local InitialSpeed = _G.DRE_TeleportSpeed or 300
...
SpeedTextBox.FocusLost:Connect(function()
    ...
    if Value then
        ...
        _G.DRE_TeleportSpeed = Value

        if _G.DRE_TeleportSystem then
            _G.DRE_TeleportSystem.SetSpeed(Value)
        end
        ...
        print("[DRE] Teleport Speed: " .. tostring(Value))
    else
        SpeedTextBox.Text = "300"
        _G.DRE_TeleportSpeed = 300

        if _G.DRE_TeleportSystem then
            _G.DRE_TeleportSystem.SetSpeed(300)
        end
...
if _G.DRE_TeleportSpeed == nil then
    _G.DRE_TeleportSpeed = 300
end
...
local function ToggleWalkSpeed()
    ...
    if WalkSpeedEnabled then
        ...
        if _G.DRE_WalkSpeed then
            _G.DRE_WalkSpeed.SetValue(WalkSpeedValue)
            _G.DRE_WalkSpeed.Enable()
        end
    else
        WalkSpeedCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        WalkSpeedStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.DRE_WalkSpeed then
            _G.DRE_WalkSpeed.Disable()
        end
    end
end
...
WalkSpeedTextBox.FocusLost:Connect(function()
    ...
    if val then
        ...
        if WalkSpeedEnabled and _G.DRE_WalkSpeed then
            _G.DRE_WalkSpeed.SetValue(WalkSpeedValue)
        end
    else
        WalkSpeedTextBox.Text = tostring(WalkSpeedValue)
...
local function ToggleAntiTrap()
    ...
    if AntiTrapEnabled then
        ...
        if _G.DRE_AntiTrap then
            _G.DRE_AntiTrap.Enable()
        end
    else
        AntiTrapCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiTrapStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.DRE_AntiTrap then
            _G.DRE_AntiTrap.Disable()
        end
    end
end
...
GodModeButton.MouseButton1Click:Connect(function()
    if _G.DRE_GodMode then
        _G.DRE_GodMode.Enable()
    end
...
FastClickButton.MouseButton1Click:Connect(function()
    if not _G.DRE_ManualFastClick then
        warn("[DRE] ManualFastClick feature not loaded")
        ShowNotification("Manual Fast Click Not Loaded")
        return
    end

    if _G.DRE_ManualFastClick.IsEnabled() then
        _G.DRE_ManualFastClick.Disable()
        ShowNotification("Manual Fast Click Stop")
    else
        _G.DRE_ManualFastClick.Enable()
...
task.spawn(function()
    task.wait(0.5)
    if _G.DRE_ManualFastClick then
        if _G.DRE_ManualFastClick.IsEnabled() then
...
local function ToggleAntiAFK()
    ...
    if AntiAFKEnabled then
        ...
        if _G.DRE_AntiAFK then
            _G.DRE_AntiAFK.Enable()
        end
    else
        AntiAFKCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiAFKStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.DRE_AntiAFK then
            _G.DRE_AntiAFK.Disable()
        end
    end
end
...
task.spawn(function()
    ...
    -- ✅ Sync Dropdown
    if _G.DRE_SelectedMethod then
        SelectedMethod = _G.DRE_SelectedMethod
        DropdownBtn.Text = SelectedMethod .. " ▼"
    end

    -- ✅ Sync Speed
    if _G.DRE_TeleportSpeed then
        SpeedTextBox.Text = tostring(_G.DRE_TeleportSpeed)
    end

    -- ✅ Sync Anti AFK
    if _G.DRE_AntiAFK then
        if _G.DRE_AntiAFK.IsEnabled() then
            AntiAFKEnabled = true
